...
export const metadata = {
  ...
  description: "See how contracts perform year-over-year on CMS Part C & Part D Quality Improvement measures.",
};
        ...
        <div className="flex min-h-screen flex-1 flex-col">
          <header className="flex items-center justify-between border-b border-border px-10 py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-[0.6rem] uppercase tracking-[0.55em] text-muted-foreground">Quality Improvement</p>
                <h1 className="text-2xl font-semibold text-foreground">Part C & Part D Momentum</h1>
              </div>
            </div>
